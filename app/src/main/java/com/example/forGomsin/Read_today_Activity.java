...
public class Read_today_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_read_today_);
        ...
        Cursor cursor = dbDiary.rawQuery("select title, dtext, rating, strftime('%Y-%m-%d', date) from dbDiary where date='" + today + "'", null);
